...
func StartServer() {
	...
	autoparts := []backend.Autoparts{
		...
		{3, "Тепловой насос", "Тепловой насос в сборе (теплообменник, бачок расширительный, трубки фреона, клапана, электропроводка), Tesla Model 3, Y.", "autopart5.jpg", []string{"1547595-96-F", ", 1523000-96-E", "1523001-00-D"}},
		...
		{5, "Модуль управления двери передней левой", "Блок управления двери передней левой, Tesla Model X.", "autopart3.jpg", []string{"1037222-00-C", "1751222-00-D", "170347162-00-A"}},
	}
