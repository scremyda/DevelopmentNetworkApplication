...
func StartServer() {
	...
	autoparts := []backend.Autoparts{
		{1, "Прицепное устройство (фаркоп)", "Прицепное устройство Bosal, под фаркоп, в сборе с розеткой, Tesla Model X.", "image1.jpg", []string{"1027581-00-D", "1046032-00-C", "10057987-001"}},
